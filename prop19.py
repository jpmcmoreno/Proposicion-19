...
def cargar_pasos_excel():
    ...
    try:
        return pd.read_excel("C:/Users/jpmcm/OneDrive/Escritorio/Matemática Fundamental/Proposicion 19 aplicación/pruebaV2.xlsx")
    except:
        return pd.DataFrame({
            'paso': [1, 2, 3, 4],
            'descripcion': [
...
proposiciones_euclides = pd.read_excel('C:/Users/jpmcm/OneDrive/Escritorio/Matemática Fundamental/Proposicion 19 aplicación/proposiciones_euclides.xlsx')
...
def main():
    st.title("Elementos de Euclides - Proposición I.XIX")

    st.markdown(f"## {invocar_descripcion("Proposición I.XIX", proposiciones_euclides)}")
